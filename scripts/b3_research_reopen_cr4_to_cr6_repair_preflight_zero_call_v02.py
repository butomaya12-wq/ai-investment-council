...
from aic.research.reopen_judge_cr4_to_cr6_repair_preflight_runtime_fix_v02 import (
    CR4ToCR6RepairPreflightRuntimeFixError,
    build_preflight,
    verify_preflight,
)
...
def _read_json(path: Path, *, label: str) -> dict:
    try:
        ...
        raise CR4ToCR6RepairPreflightRuntimeFixError(
