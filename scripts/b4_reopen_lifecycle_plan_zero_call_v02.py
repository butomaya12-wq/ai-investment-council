...
from aic.council.reopen_lifecycle_plan_v02 import (
    load_and_build_b4_reopen_lifecycle_plan_v02,
)
...
DEFAULT_OUTPUT = Path(".aic-runtime/b4_reopen_lifecycle_plan_zero_call_v0_2.json")
...
def main() -> int:
    ...
    parser.add_argument(
        "--initial-selected-model-authority",
        type=Path,
        default=DEFAULT_INITIAL_AUTHORITY,
    )
    ...
    artifact = load_and_build_b4_reopen_lifecycle_plan_v02(
