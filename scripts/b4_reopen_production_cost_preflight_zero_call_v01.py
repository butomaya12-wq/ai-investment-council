...
DEFAULT_OUTPUT = Path(".aic-runtime/b4_reopen_production_cost_preflight_zero_call_v0_1.json")
...
def main() -> int:
    ...
    artifact = load_and_build_b4_reopen_production_cost_preflight(
    ...
    print("COST_AUTHORITY_MODE=STAGED_EXACT")
    print("EXACTLY_COSTED_NOW_STAGE=INITIAL")
    print("MODEL_CALLS=0")
