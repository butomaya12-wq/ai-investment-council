...
from aic.council.initial_runtime_diagnosis import diagnose_blocked_initial_runtime
...
DEFAULT_BLOCKED = Path(".aic-runtime/b4_initial_council_freeze_v0_2.json")
...
DEFAULT_OUTPUT = Path(".aic-runtime/b4_initial_runtime_block_diagnosis_v0_1.json")
...
def main() -> int:
    ...
    artifact = diagnose_blocked_initial_runtime(
    ...
    if artifact["artifact_hash"] != expected_hash:
        raise ValueError("diagnosis artifact hash mismatch")
    ...
    public = {
        ...
        "material_non_supported_claim_count": artifact["material_non_supported_claim_count"],
